...
KUSTO_CONF_CONNECTIONSTRING = "connection_string"
KUSTO_CONF_AAD_APP_ID = "aad_app_id"
KUSTO_CONF_AAD_APP_KEY = "aad_app_key"
KUSTO_CONF_AAD_AUTHORITY_ID = "aad_authority_id"
...
COMPONENT_CONFIG_SCHEMA_CONNECTION = {
    vol.Required(KUSTO_CONF_AAD_APP_ID): cv.string,
    vol.Required(KUSTO_CONF_AAD_APP_KEY): cv.string,
    vol.Required(KUSTO_CONF_AAD_AUTHORITY_ID): cv.string,
    vol.Required(KUSTO_CONF_CONNECTIONSTRING): cv.url,
}
